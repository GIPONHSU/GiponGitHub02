...
export default function Arena({ players, modelTypes = [1, 2, 3, 4], gameMode, energyPerCoin = 15, isPaused = false, onGameOver }: { players: boolean[], modelTypes?: number[], gameMode: 'campaign' | 'versus', energyPerCoin?: number, isPaused?: boolean, onGameOver: (msg: string, stats?: PlayerStats[]) => void }) {
