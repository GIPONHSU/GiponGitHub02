...
export default function App() {
  const [status, setStatus] = useState<'modeSelect' | 'menu' | 'loading' | 'playing' | 'gameover' | 'results' | 'fbxPreview'>('modeSelect');
  ...
  const renderContent = () => {
    switch (status) {
      ...
      case 'fbxPreview':
        return <FBXPreviewScreen onBack={() => setStatus('modeSelect')} />;
      default:
        return null;
    }
  };
