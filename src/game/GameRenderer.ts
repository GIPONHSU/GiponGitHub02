...
import { createTopSprite, createZombieSprite, createBarrelSprite, createCrateSprite, createZombieBossSprite, createZombieBombSprite, createZombieBouncingSprite, createZombieGoldenSprite, createZombieBlackSprite } from './spriteLoader';
