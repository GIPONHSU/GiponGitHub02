...
export function updateZombies(this: GameEngine, dt: number, zombieTargets: Top[]) {
        ...
        this.zombies.forEach(z => {
            ...
            if (z.hp <= 0 && !z.markForDeletion && !(z as any).isDying) {
                ...
                const isBig = z.type === 'zombie_big' || z.type === 'zombie_bomb' || z.type === 'zombie_bouncing' || z.type === 'zombie_golden' || z.type === 'zombie_black';
                ...
                if (isBoss) {
                    ...
                    mainColor = '#374151'; secondColor = '#111827';
            ...
            if (z.type === 'zombie_black') { // Handled in BlackZombie.ts
